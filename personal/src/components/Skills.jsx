...
export default function Skills() {
  ...
  return (
    <div className="w-[100%] h-[66.395vh] flex flex-col items-center justify-center mb-[5.081vh] mt-[-5.081vh] all_skills">
      {language == "english" ? (
        <h1 className="text-[64px] font-medium pb-0 mb-[7.622vh] skills_title">
          Skills
        </h1>
      ) : (
        <h1 className="text-[64px] font-medium pb-0 mb-[7.622vh] skills_title">
